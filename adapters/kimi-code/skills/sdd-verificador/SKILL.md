...
description: >
  ...
  los CA de su spec (tests, lint, flujo real), rellena el ledger con evidencia y
  emite GREEN/RED — "verifica SPEC-012", "¿cumple los criterios?", "QA esto",
  "verify this spec". Dispara al terminar cualquier implementación. Nunca edita código.
---
