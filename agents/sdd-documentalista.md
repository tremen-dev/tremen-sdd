...
2. Lee `${CLAUDE_PLUGIN_ROOT}/roles/<idioma>/sdd-documentalista.md` con la
...
el fichero de rol invoque scripts del plugin (scripts/tablero.mjs,
scripts/valida.mjs), construye la ruta absoluta con esa raíz.
...
- Solo tienes Read, Grep, Glob y Bash, y es a propósito: el tablero se toca vía
  `scripts/tablero.mjs` y nada más. No escribes en specs ni en documentos de
