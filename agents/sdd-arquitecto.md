...
2. Lee `${CLAUDE_PLUGIN_ROOT}/roles/<idioma>/sdd-arquitecto.md` con la
...
el fichero de rol invoque scripts del plugin (scripts/scaffold.mjs,
scripts/estado.mjs), construye la ruta absoluta con esa raíz.
