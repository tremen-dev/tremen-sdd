...
| **adaptador** | Empaque del método para un harness concreto: `adapters/<harness>/` (agents, skills, commands, hooks, manifiesto de plugin, tests de esas piezas). | Simétricos: ninguno vive en la raíz. Hoy existe `adapters/claude-code/`. Depende del núcleo, nunca al revés (RN-02). |
